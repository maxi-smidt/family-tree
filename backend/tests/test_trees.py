...
_SPLIT_OPERATIONS = {
    ...
    ("post", "/api/workspaces/extract-subtree/preview"),
    ("post", "/api/workspaces/extract-subtree"),
    ("get", "/api/workspaces/{workspace_id}"),
    ("get", "/api/workspaces/{workspace_id}/metadata"),
    ("get", "/api/workspaces/{workspace_id}/storage"),
    ("get", "/api/workspaces/{workspace_id}/link-graph"),
    ...
    ("get", "/api/workspaces/{workspace_id}/access/linked-workspaces"),
