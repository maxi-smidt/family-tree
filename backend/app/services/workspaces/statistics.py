...
def compute_statistics(members: list[Member], workspace_id: str) -> StatisticsReport:
    ...
    return StatisticsReport(
        ...
        top_first_names=[
            NameCount(name=n, count=c) for n, c in first_name_counter.most_common(10)
        ],
        top_last_names=[
            NameCount(name=n, count=c) for n, c in last_name_counter.most_common(10)
        ],
    )
