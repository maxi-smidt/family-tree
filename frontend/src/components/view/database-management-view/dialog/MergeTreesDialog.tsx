                ...
                <MergePreview
                  previewData={{
                    conflicts: previewData.duplicates.map((d) => ({
                      ...
                      academicTitle: d.member_a.academic_title ?? null,
                      firstName: d.member_a.first_name ?? "",
                      middleNames: d.member_a.middle_names ?? null,
                      baptismalName: d.member_a.baptismal_name ?? null,
                      lastName: d.member_a.last_name ?? "",
                      maidenName: d.member_a.maiden_name ?? null,
                      imageData: d.member_a.image_data ?? null,
                      deceased: d.member_a.deceased ?? false,
                      date: {
                        birth: d.member_a.date_of_birth ?? "",
                        death: d.member_a.date_of_death ?? null,
                      },
                      parents: {
                        paternalParent: null,
                        maternalParent: null,
                      },
                      additionalData: d.member_a.additional_data ?? null,
